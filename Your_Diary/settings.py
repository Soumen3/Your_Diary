"""
Django settings for Your_Diary project.
...
SECRET_KEY = 'django-insecure-_11k07ho#okb+cn%d)*6y1i!mo(@bztinh1!@mfr+1)u7ye3za'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
				...
				'diary.context_processors.site',
            ],
        },
    },
]

WSGI_APPLICATION = 'Your_Diary.wsgi.application'
...
# Custom User Model
AUTH_USER_MODEL = "diary.User" # Path: Your_Diary/diary/models.py
